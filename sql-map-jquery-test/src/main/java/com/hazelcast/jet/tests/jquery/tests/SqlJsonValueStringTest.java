...
public class SqlJsonValueStringTest extends AbstractJValueMapTest {
    ...
    public SqlJsonValueStringTest(String mapName, String inputJsonFile, String sqlQuery, String expectedJsonFile,
                                  Boolean resultIsArray, Boolean resultRequiredSort)
            throws IOException, URISyntaxException {
        super(mapName, inputJsonFile, sqlQuery, expectedJsonFile, resultIsArray, resultRequiredSort);
    }

    public static void main(String... args) throws Exception {
        new SqlJsonValueStringTest(JSON_MAP_NAME, INPUT_JSON_FILE, SQL_QUERY, RESULT_JSON_PATH, RESULT_IS_ARRAY,
