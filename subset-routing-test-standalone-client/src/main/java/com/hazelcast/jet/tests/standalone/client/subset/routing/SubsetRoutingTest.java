...
package com.hazelcast.jet.tests.standalone.client.subset.routing;
...
public class SubsetRoutingTest extends AbstractClientSoakTest {
    ...
    protected List<ClusterType> runOnClusters() {
        List<ClusterType> clusterTypes = new java.util.ArrayList<>();
        clusterTypes.add(DYNAMIC);
        clusterTypes.add(STABLE);
        return clusterTypes;
    }
